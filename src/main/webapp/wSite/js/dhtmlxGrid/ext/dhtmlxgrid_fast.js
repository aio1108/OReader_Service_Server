...
*/
 ...
 if (!c){c=this._cellCache[cell._cellIndex]=this._disA[3].apply(this,[cell]);c.destructor=function(){return true};c.setCValue=function(val){c.cell.innerHTML=val}};c.cell=cell;c.combo=cell._combo||this.combos[cell._cellIndex];return c}};dhtmlXGridObject.prototype.stopFastOperations = function(){if (!this._disF)return;for (var i = this._disF.length - 1;i >= 0;i--){this[this._disF[i]]=this._disA[i]};this.setSizes();this.callEvent("onGridReconstructed",[])};//(c)dhtmlx ltd. www.dhtmlx.com
//v.2.1 build 90226
