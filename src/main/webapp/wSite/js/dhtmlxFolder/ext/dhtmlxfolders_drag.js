...
*/
	...
	*/
    dhtmlxFolders.prototype._dragInTree=function(tree,tobj,bnod,item){
    	var that=item.ex;
    	if (!tree.callEvent("onDrag",[that._dragged[0],tobj.id,null,this,tree])) return;
	...
	*/
	dhtmlxFolders.prototype._drag=function(sourceHtmlObject,dhtmlObject,targetHtmlObject,lastLanding){
		...
		if (!this.callEvent("onDrag",[sourceHtmlObject.itemObj.data.id,targetHtmlObject.itemObj.data.id,this._dndPos,this,this])) return;
